...
\begin{document}
    ...
    Dans notre cas, nous aurons besoin de définir un endpoint pour 

    \subsection{Monitoring du modèle}
    (Pas forcément de code à mettre, il faut seulement parler des métriques de performances à utiliser et des mécanismes de monitoring qui peuvent être mis en place)

    \newpage
    \begin{thebibliography}{4}
        \bibitem[1]{menculini} Menculini, L.; Marini, A.; Proietti, M.; Garinei, A.; Bozza, A.; Moretti, C.; Marconi, M. Comparing Prophet and Deep Learning to ARIMA in Forecasting Wholesale Food Prices. Forecasting 2021, 3, 644-662. https://doi.org/10.3390/forecast3030040
        \bibitem[2]{uzel} ÜZEL, Ziyar. Comparative Analysis of LSTM, ARIMA, and Facebook’s Prophet for Traffic Forecasting: Advancements, Challenges, and Limitations. 2023. 
